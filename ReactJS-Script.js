...
var firstClickedProducts = false;
var clickedProducts = [];
...
function functionality() {
 ...
 let endInd = parseInt(indexNow) + 20;
 ...
 //Loops through as many times as you want times to click on products
...
function saveDataToFile() {
   ...
   saveAs(textFile, "ScriptttResult.txt"); 
}
